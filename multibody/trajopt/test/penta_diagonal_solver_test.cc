#include "drake/multibody/trajopt/penta_diagonal_solver.h"
...
#include "drake/multibody/trajopt/penta_diagonal_matrix.h"
...
GTEST_TEST(PentaDiagonalMatrixTest, SolveBlockDiagonal) {
  ...
  PRINT_VAR(x.transpose());
  PRINT_VAR(x_expected.transpose());
  PRINT_VAR((x - x_expected).norm());
